...
<!-- begin form -->
		...
		echo form_dropdown('is_sleep', $options, set_value('phone', $is_sleep));
		?>
                    </li>
		...
		echo form_dropdown('is_healthy', $options, set_value('phone', $is_healthy));
		?>
		...
		echo form_dropdown('is_excersise', $options, set_value('phone', $is_excersise));
		?>
                    </li>
		...
		echo form_dropdown('is_meditation', $options, set_value('phone', $is_meditation));
		?>
                    </li>
		...
		echo form_dropdown('is_spirituality', $options, set_value('phone', $is_spirituality));
		?>
                    </li>
		...
		echo form_dropdown('is_groups', $options, set_value('phone', $is_groups));
		?>
                    </li>
		...
		echo form_dropdown('is_community', $options, set_value('phone', $is_community));
		?>
                   </li>
		...
		echo form_dropdown('is_family', $options, set_value('phone', $is_family));
		?>
                    </li>
		...
		echo form_dropdown('is_enjoy', $options, set_value('phone', $is_enjoy));
		?>
                    </li>
		...
		echo form_dropdown('is_religion', $options, set_value('phone', $is_religion));
		?>
                    </li>
		...
		echo form_dropdown('is_recovery', $options, set_value('phone', $is_recovery));
		?>
                    </li>
		...
		echo form_dropdown('is_life', $options, set_value('phone', $is_life));
		?>
                    </li>
