...
<!-- begin form -->
		...
		echo form_dropdown('is_drug', $options, set_value('phone', ''));
		?>
                   </li>
		...
		echo form_dropdown('is_drug_week', $options, set_value('phone', ''));
		?></li>
		...
		echo form_dropdown('is_alcohol', $options, set_value('phone', ''));
		?>
                    </li>
 ...
 <?php
		...
		echo form_dropdown('is_alcohol_week', $options, set_value('phone', ''));
		?>
                    </li>
		...
		echo form_dropdown('is_alcohol_friend', $options, set_value('phone', ''));
		?>
                    </li>
		...
		echo form_dropdown('is_alcohol_family', $options, set_value('phone', ''));
		?>
        </li>
		...
		echo form_dropdown('is_cravings', $options, set_value('phone', ''));
		?>
		...
		echo form_dropdown('is_dreams', $options, set_value('phone', ''));
		?>
                    </li>
		...
		echo form_dropdown('is_triggers', $options, set_value('phone', ''));
		?>
        </li>
		...
		echo form_dropdown('is_plans', $options, set_value('phone', ''));
		?>       
</li>
		...
		echo form_dropdown('last_alcohol', $options, set_value('phone', ''));
		?> 
                    </li>
...
<?php
		...
		echo form_dropdown('last_drugs', $options, set_value('phone', ''));
		?> 
</li>
...
<!-- .entry-content -->
											...
											<a href="<?php echo base_url('forms/recoveryvitals_form') ?>" style="   background-color: #6195C5;
    border: 2px solid #142872;
    bottom: 5px;
    color: #FFFFFF;
    cursor: pointer;
