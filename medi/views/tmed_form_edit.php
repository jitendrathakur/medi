...
.main-container {height: 640px;!important}
  ...
  <?php
		...
		echo form_dropdown('is_medicine', $options, set_value('phone', $is_medicine));
		?></li>
		...
		echo form_dropdown('is_psychiatric', $options, set_value('phone', $is_psychiatric));
		?>
                    </li>
    ...
    echo 'checked';
		...
		echo form_dropdown('is_question_medicine', $options, set_value('phone', $is_question_medicine));
		?></li>
		...
		echo form_dropdown('is_question_psychiatric', $options, set_value('phone', $is_question_psychiatric));
		?></li>
