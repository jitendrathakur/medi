...
<!-- begin form -->
		...
		echo form_dropdown('is_parole', $options, set_value('phone', $is_parole));
		?>
        </li>
		...
		echo form_dropdown('is_month', $options, set_value('phone', $is_month));
		?>
                    </li>
 ...
 <?php
		...
		echo form_dropdown('is_charge', $options, set_value('phone', $is_charge));
		?>                    </li>
		...
		echo form_dropdown('is_fines', $options, set_value('phone', $is_fines));
		?>
                    </li>
		...
		echo form_dropdown('is_week', $options, set_value('phone', $is_week));
		?>
                    </li>
...
<?php
		...
		echo form_dropdown('is_residence', $options, set_value('phone', $is_residence));
		?>
        </li>
		...
		echo form_dropdown('is_criminal', $options, set_value('phone', $is_criminal));
		?>
                    </li>
		...
		echo form_dropdown('is_friends', $options, set_value('phone', $is_friends));
		?>
 ...
 <?php
		...
		echo form_dropdown('is_volunteer', $options, set_value('phone', $is_volunteer));
		?></li>
		...
		echo form_dropdown('arrest', $options, set_value('phone', $arrest));
		?> 
                    </li>
 ...
 <?php
		...
		echo form_dropdown('incarceration', $options, set_value('phone', $incarceration));
		?> 
        </li>
