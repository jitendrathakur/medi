...
.main-container {height: 630px;!important}
 ...
 <?php if ($this->session->flashdata('message')):?>
	...
	<div style="height:100%; " id="mainForm" >
		...
		echo form_dropdown('feel', $options, set_value('phone', $feel));
		?>
		...
		echo form_dropdown('wellness', $options, set_value('phone', $wellness));
		?>
                    </li>
    ...
    echo 'checked';
		...
		echo form_dropdown('hospitalization', $options, set_value('phone', $hospitalization));
		?> 
                    </li>
		...
		echo form_dropdown('crisis', $options, set_value('phone', $crisis));
		?> 
        </li>
