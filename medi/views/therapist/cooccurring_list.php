<div class="journal-entries well" >	
	...
	<tr>
		...
		?>
		 <a class ="" href="<?php echo base_url('therapist/cooccurring_list/').'/'.$page.'/user_id/'.$sort  ?>" >Patient</a>				
		</th>
        ...
        $sort = ($order == 'ASC') ? 'DESC' : 'ASC';
		?>
		<a class ="" href="<?php echo base_url('therapist/cooccurring_list/').'/'.$page.'/cr_timestamp/'.$sort  ?>" >Created</a>
		</th>		
