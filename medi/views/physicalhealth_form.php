...
.main-container {height: 650px;!important}
    ...
    //echo 'checked';
		...
		echo form_dropdown('is_std', $options, set_value('phone', ''));
		?>
                   </li>
 ...
 <?php
		...
		echo form_dropdown('is_physical', $options, set_value('phone', ''));
		?></li>
 ...
 <?php
		...
		echo form_dropdown('is_hearing', $options, set_value('phone', ''));
		?></li>
 ...
 <?php
		...
		echo form_dropdown('is_provider', $options, set_value('phone', ''));
		?></li>
		...
		echo form_dropdown('is_treatment', $options, set_value('phone', ''));
		?>
                    </li>
		...
		echo form_dropdown('is_meds', $options, set_value('phone', ''));
		?></li>
		...
		echo form_dropdown('is_counter', $options, set_value('phone', ''));
		?>
		...
		echo form_dropdown('is_remedies', $options, set_value('phone', ''));
		?>
                    </li>
...
<?php
		...
		echo form_dropdown('is_weight', $options, set_value('phone', ''));
		?>
</li>
		...
		echo form_dropdown('is_happy', $options, set_value('phone', ''));
		?>
                    </li>
		...
		echo form_dropdown('is_pain', $options, set_value('phone', ''));
		?>
                </li>
</ul>
...
<?php */?>
	...
	<div id="content" role="main" >
		...
		<div id="post-9" class="post-9 page type-page status-publish hentry" >
    				...
    				<a href="<?php echo base_url('forms/tmed_form') ?>" style="   background-color: #6195C5;
    border: 2px solid #142872;
    bottom: 52px;
    color: #FFFFFF;
    cursor: pointer;
