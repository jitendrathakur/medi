<?php include('header.php'); ?>
    ...
    <?php echo form_open_multipart($this->config->item('admin_folder').'forms/core_journal_form2_edit/'.$id, array('class' => 'form-horizontal')); ?>  
	    ...
	    <div class="form-group">
	        ...
	        <div class="col-sm-10">
	          <?php
			$data	= array('id' => 'renewal', 'name'=>'renewal', 'value'=>set_value('renewal', $renewal), 'class'=>'form-control');
			echo form_input($data); ?>
	        </div>
	    </div>
	    ...
	    <div class="form-group">
	        ...
	        <div class="col-sm-10">
	          	<?php
				$data	= array('name'=>'plan', 'value'=>set_value('plan', $plan), 'class'=>'form-control');
				echo form_input($data); ?>
	        </div>
	    </div>
