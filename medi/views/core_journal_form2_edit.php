...
.main-container {height: 950px;!important}
	...
	<div style="height:100%; " id="mainForm" >
		...
		<!-- begin form -->
		 <?php echo form_open_multipart($this->config->item('admin_folder').'forms/core_journal_form2_edit/'.$id); ?>
			...
			echo form_input($data); ?>
				<li id="fieldBox_94" class="mainForm">
					<label class="formFieldQuestion">Renewal:&nbsp;*</label>
                     <?php
			$data	= array('name'=>'renewal', 'value'=>set_value('renewal', $renewal), 'class'=>'mainForm','style'=>'border-image:initial; height:20px; color:#000000; border:1px solid #000000;');
			echo form_input($data); ?>
                    </li>
				...
				<li id="fieldBox_95" class="mainForm">
					<label class="formFieldQuestion">T-MeD Plan#:&nbsp;*</label>
                      ...
                      <?php
			$data	= array('name'=>'plan', 'value'=>set_value('plan', $plan), 'class'=>'mainForm','style'=>'border-image:initial; height:20px; color:#000000; border:1px solid #000000;');
			echo form_input($data); ?>
                    </li>
				...
				<li id="fieldBox_97" class="mainForm">
                    ...
                    <?php
				$data	= array('name'=>'step1',  'value'=>set_value('step1', $step1),'style'=>'border-image:initial; height:100px; color:#000000; border:1px solid #000000;');
				echo form_textarea($data);
				?>
                   </li>
 ...
 <?php
				$data	= array('name'=>'step2',  'value'=>set_value('step2', $step1),'style'=>'border-image:initial; height:100px; color:#000000; border:1px solid #000000;');
				echo form_textarea($data);
				?>
</li>
				...
				<li id="fieldBox_99" class="mainForm">
					<label class="formFieldQuestion">Step III:&nbsp;*</label>
                     <?php
				$data	= array('name'=>'step3',  'value'=>set_value('step3', $step1),'style'=>'border-image:initial; height:100px; color:#000000; border:1px solid #000000;');
				echo form_textarea($data);
				?>
                    </li>
 ...
 <?php
				$data	= array('name'=>'target',  'value'=>set_value('target', $target),'style'=>'border-image:initial; height:100px; color:#000000; border:1px solid #000000;');
				echo form_textarea($data);
				?>
</li>
